...
A collection of [Claude Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview) for international tax work — step-by-step workflows that guide Claude (and the humans using it) through recurring analyses like CFC determinations, subpart F/GILTI inclusion questions, and related international tax mechanics.
